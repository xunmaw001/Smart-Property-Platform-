        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.bianminName" type="text" v-model="ruleForm.bianminName" placeholder="便民服务名称"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">便民服务编号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.bianminUuidNumber" type="text" v-model="ruleForm.bianminUuidNumber" placeholder="便民服务编号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="bianminPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">便民服务照片</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.bianminPhoto" :src="baseUrl+ruleForm.bianminPhoto" mode="aspectFill">
                        </image>
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">便民服务地点</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.bianminAddress" type="text" v-model="ruleForm.bianminAddress" placeholder="便民服务地点"></input>
            </view>
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">便民服务类型</view>
                    <picker @change="bianminTypesChange" :value="bianminTypesIndex" :range="bianminTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.bianminTypes?ruleForm.bianminValue:"请选择便民服务类型"}}</view>
                    </picker>
                </view>
            <view
                ...
                <textarea :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.bianminContent" v-model="ruleForm.bianminContent" placeholder="便民服务介绍"/>
            </view>
...
<script>
    ...
    export default {
        data() {
            ...
            ruleForm: {
					bianminName: '',
					bianminUuidNumber: this.getUUID(),//数字
					bianminPhoto: '',
					bianminAddress: '',
					bianminTypes: '',//数字
					bianminValue: '',//数字对应的值
		...
		/*下拉框*/
			let bianminTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'bianmin_types',
            }
			let bianminTypes = await this.$api.page(`dictionary`, bianminTypesParams);
			this.bianminTypesOptions = bianminTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`bianmin`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.bianminId){
                this.ruleForm.bianminId = options.bianminId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.bianminName)) {
                    this.$utils.msg(`便民服务名称不能为空`);
                    return
                }
				if ((!this.ruleForm.bianminUuidNumber)) {
                    this.$utils.msg(`便民服务编号不能为空`);
                    return
                }
				if ((!this.ruleForm.bianminPhoto)) {
                    this.$utils.msg(`便民服务照片不能为空`);
                    return
                }
				if ((!this.ruleForm.bianminAddress)) {
                    this.$utils.msg(`便民服务地点不能为空`);
                    return
                }
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`bianmin`, this.ruleForm);
                } else {
                    await this.$api.save(`bianmin`, this.ruleForm);
                }
