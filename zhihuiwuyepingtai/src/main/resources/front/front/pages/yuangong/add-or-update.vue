    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">员工姓名</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.yuangongName" type="text" v-model="ruleForm.yuangongName" placeholder="员工姓名"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">员工手机号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.yuangongPhone" type="text" v-model="ruleForm.yuangongPhone" placeholder="员工手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">员工身份证号</view>
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.yuangongIdNumber" type="text" v-model="ruleForm.yuangongIdNumber" placeholder="员工身份证号"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="yuangongPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">员工照片</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.yuangongPhoto" :src="baseUrl+ruleForm.yuangongPhoto" mode="aspectFill">
                        </image>
    ...
    export default {
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`yuangong`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.yuangongId){
                this.ruleForm.yuangongId = options.yuangongId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.yuangongName)) {
                    this.$utils.msg(`员工姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.yuangongPhone) && (!this.$validate.isMobile(this.ruleForm.yuangongPhone))) {
                    this.$utils.msg(`员工手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.yuangongIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.yuangongIdNumber))) {
                    this.$utils.msg(`员工身份证号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.yuangongPhoto)) {
                    this.$utils.msg(`员工照片不能为空`);
                    return
                }
                ...
                if (this.ruleForm.id) {
                    ...
                    await this.$api.save(`yuangong`, this.ruleForm);
                }
