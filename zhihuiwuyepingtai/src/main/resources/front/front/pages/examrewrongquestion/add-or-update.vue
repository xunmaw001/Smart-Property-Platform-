...
<script>
    ...
    export default {
        data() {
            ...
            exampaperOptions: [],//试卷（外键）
            exampaperIndex : 0,//试卷（外键）下标
            examquestionOptions: [],//试题id（外键）
            examquestionIndex : 0,//试题id（外键）下标
