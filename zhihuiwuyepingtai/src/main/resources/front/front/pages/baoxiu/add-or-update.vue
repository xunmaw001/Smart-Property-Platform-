        ...
        <form class="app-update-pv">
            ...
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.baoxiuName" type="text" v-model="ruleForm.baoxiuName" placeholder="报修名称"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="baoxiuPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">报修图片</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.baoxiuPhoto" :src="baseUrl+ruleForm.baoxiuPhoto" mode="aspectFill">
                        </image>
                      ...
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">报修类型</view>
                    <picker @change="baoxiuTypesChange" :value="baoxiuTypesIndex" :range="baoxiuTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.baoxiuTypes?ruleForm.baoxiuValue:"请选择报修类型"}}</view>
                    </picker>
                </view>
               <!-- <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                      class="cu-form-group">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">报修状态</view>
                    <picker @change="baoxiuZhuangtaiTypesChange" :value="baoxiuZhuangtaiTypesIndex" :range="baoxiuZhuangtaiTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.baoxiuZhuangtaiTypes?ruleForm.baoxiuZhuangtaiValue:"请选择报修状态"}}</view>
                    </picker>
                </view> -->
            <view
                ...
                <textarea :style='{"padding":"0 30rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"10rpx 2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx","height":"200rpx"}'
                          :disabled="ro.baoxiuContent" v-model="ruleForm.baoxiuContent" placeholder="报修详情"/>
            </view>
...
<script>
    ...
    export default {
		...
		/*下拉框*/
			let baoxiuTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'baoxiu_types',
            }
			let baoxiuTypes = await this.$api.page(`dictionary`, baoxiuTypesParams);
			this.baoxiuTypesOptions = baoxiuTypes.data.list
		/*下拉框*/
			let baoxiuZhuangtaiTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'baoxiu_zhuangtai_types',
            }
			let baoxiuZhuangtaiTypes = await this.$api.page(`dictionary`, baoxiuZhuangtaiTypesParams);
			this.baoxiuZhuangtaiTypesOptions = baoxiuZhuangtaiTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`baoxiu`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.baoxiuId){
                this.ruleForm.baoxiuId = options.baoxiuId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.baoxiuName)) {
                    this.$utils.msg(`报修名称不能为空`);
                    return
                }
				if ((!this.ruleForm.baoxiuPhoto)) {
                    this.$utils.msg(`报修图片不能为空`);
                    return
                }
    ...
    //                 return
    //             }
				this.ruleForm.baoxiuZhuangtaiTypes=2
                if (this.ruleForm.id) {
                    await this.$api.update(`baoxiu`, this.ruleForm);
                } else {
                    await this.$api.save(`baoxiu`, this.ruleForm);
                }
