        ...
        <el-form
            ...
            <input id="fangwuId" name="fangwuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴费月份" prop="jiaofeiYuefen">
                       <el-input v-model="ruleForm.jiaofeiYuefen"
                                 placeholder="缴费月份" clearable  :readonly="ro.jiaofeiYuefen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.jiaofeiContent"  label="缴费详情" prop="jiaofeiContent">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否缴费" prop="jiaofeiShifouTypes">
                        <el-select v-model="ruleForm.jiaofeiShifouTypes" :disabled="ro.jiaofeiShifouTypes" placeholder="请选择是否缴费">
                            <el-option
