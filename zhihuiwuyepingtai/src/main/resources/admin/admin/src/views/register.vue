    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">智慧物业平台注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            ...
                            <el-form-item label="员工照片" class="input" v-if="tableName=='yuangong'">
                                    <file-upload
                                        tip="点击上传员工照片"
                                        action="file/upload"
                                        :limit="1"
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/zhihuiwuyepingtai/img/back-img-bg.jpg);
