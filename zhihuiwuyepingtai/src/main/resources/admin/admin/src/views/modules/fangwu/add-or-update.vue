               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房屋地址" prop="fangwuAddress">
                       <el-input v-model="ruleForm.fangwuAddress"
                                 placeholder="房屋地址" clearable  :readonly="ro.fangwuAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.fangwuContent"  label="房屋详情" prop="fangwuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fangwuContent" label="房屋详情" prop="fangwuContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   fangwuContent: [
                              { required: true, message: '房屋详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
